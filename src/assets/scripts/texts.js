export const TEXTS = {
    Home: {
        ...
        Cases: {
            // title: "",
            greenTitle: "Use Cases",
            casesResume: "At YourBank, we cater to the diverse needs of individuals and businesses alike, offering a wide range of financial solutions",
            individualResume: "For individuals, our mortgage services pave the way to homeownership, and our flexible personal loans provide vital support during various life milestones. We also prioritize retirement planning, ensuring a financially secure future for our customers",
            businessResume: "For businesses, we empower growth with working capital solutions that optimize cash flow, and our tailored financing options fuel business expansion. Whatever your financial aspirations, YourBank is committed to providing the right tools and support to achieve them",
        },
        Features: {
            title: "Our",
            greenTitle: "Features",
    ...
    About: {
        ...
        PressReleases: {
            prGreenTitle: "Press Releases",
            prTitleResume: "Stay updated with the latest happenings and exciting developments at YourBank through our press releases.",
        }
    },
    Security: {
        TopPriority: {
            tisTitle: "Your Security is Our",
            tisGreenBoldTtitle: "Top Priority",
            tisDescription: "At YourBank, we understand the importance of keeping your financial information secure. We employ robust security measures and advanced technologies to protect your personal and financial data. Rest assured that when you bank with us, your security is our utmost priority.",
            tisImgDescription: "Someone holding a phone with a shield on the background of the phone",
        },
        HowWeProtectYou: {
            title: "How We",
            greenTitle: "Protect You",
            pyDescription: "At YourBank, we prioritize the security and confidentiality of your financial information. Our state-of-the-art encryption technology and stringent data protection measures ensure your assets and transactions are safeguarded at all times",
        }
    },
    Standalone: {
        ...
        FAQ: {
            ...
            greenTitle: "Frequently",
            paragraph: "Still you have any questions? Contact our Team via support@yourbank.com"
        },
        CTA: {
